...
export function DecisionRowHeader({ language }: Props) {
	return (
		<div className='flex items-center gap-[2rem] px-[1rem]'>
			<p className='w-[15rem] shrink-0 text-[0.875rem] font-bold text-green-700'>
				{ADMIN_DECISIONS_TRANSLATE.columnLabels.title[language]}
			</p>
			<p className='flex-1 min-w-0 text-[0.875rem] font-bold text-green-700'>
				{ADMIN_DECISIONS_TRANSLATE.columnLabels.description[language]}
			</p>
			<p className='w-[10rem] shrink-0 text-[0.875rem] font-bold text-green-700'>
				{ADMIN_DECISIONS_TRANSLATE.columnLabels.voteStart[language]}
			</p>
			<p className='w-[10rem] shrink-0 text-[0.875rem] font-bold text-green-700'>
				{ADMIN_DECISIONS_TRANSLATE.columnLabels.voteEnd[language]}
			</p>
			<p className='w-[10rem] shrink-0 text-[0.875rem] font-bold text-green-700'>
				{ADMIN_DECISIONS_TRANSLATE.columnLabels.status[language]}
			</p>
			...
			<div className='ml-auto flex items-center gap-[1.5rem] shrink-0 invisible' aria-hidden>
				<div className='flex items-center gap-[0.375rem]'>
					...
					<p className='text-[0.875rem] whitespace-nowrap'>{ADMIN_DECISIONS_TRANSLATE.resultsPdfLabel[language]}</p>
				</div>
				<div className='flex items-center gap-[0.5rem]'>
					<p className='text-[0.875rem] whitespace-nowrap'>{ADMIN_DECISIONS_TRANSLATE.modifyLabel[language]}</p>
