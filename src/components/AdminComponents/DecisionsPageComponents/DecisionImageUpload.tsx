...
import { useGenerateDecisionImageLink } from '@/hooks/decision/useGenerateDecisionImageLink'

import { isImageValid } from '@/lib/file-upload.utils'
import { cn } from '@/lib/utils'

interface Props {
	name: keyof TypeDecisionFormState
...
// Mirrors LocalCallImageUpload.tsx but hits the decision module's own
// generate-image-upload-link endpoint (S3 'DECISIONS/' prefix).
export function DecisionImageUpload({
	name,
	height,
	language,
	control,
