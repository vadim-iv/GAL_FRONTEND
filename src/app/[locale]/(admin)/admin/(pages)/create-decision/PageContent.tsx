...
import { useCreateDecision } from '@/hooks/decision/useCreateDecision'
...
export function PageContent() {
	...
	const { createDecision, isCreatePending } = useCreateDecision()

	const { register, handleSubmit, control, formState } = useForm<TypeDecisionFormState>({
		mode: 'onSubmit',
	...
	return (
		<div className='flex justify-end w-full'>
			...
			>
				<DecisionPageNav isPending={isPending} language={language} setLanguage={setLanguage} isCreate />
